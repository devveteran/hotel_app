...
const HotelAmenities = ({amenities}: PropType) => {
    return (
        <div className="mb-4">
            <article className="text-grey-900 mb-2">
                ...
                <ul className="row row-cols-3 m-0 p-0">
                    <li className="list-group-item mb-3">
                        <span className="leading-none inline-flex transform h-6 w-6 mr-3" aria-hidden="true">
                    ...
                    <li className="list-group-item mb-3 opacity-25">
                        <span className="leading-none inline-flex transform h-6 w-6 mr-3" aria-hidden="true">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="pointer-events-none max-h-full max-w-full">
                    ...
                    <li className="list-group-item mb-3 opacity-25">
                        <span className="leading-none inline-flex transform h-6 w-6 mr-3" aria-hidden="true">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="pointer-events-none max-h-full max-w-full">
                                <path d="M12 2a10 10 0 1010 10A10 10 0 0012 2zm1 11h-3v5.46a.5.5 0 11-1 0V5.54A.52.52 0 019.5 5H13a4 4 0 010 8zm0-7h-3v6h3a3 3 0 000-6z" fill="currentColor"></path>
                            </svg>
                        </span>
            ...
            <footer className="text-end mt-0 pt-0">
                <button type="button" className="btn btn-primary-check border">Show all amenities</button>
            </footer>
        </div>        
    )
}
