            ...
            <div className="container">
                <div className="row g-4 justify-content-between align-items-center">
                    <div className="col-lg-5 position-relative">
                        ...
                        <img src={require("@images/about/01.jpg")} className="rounded-3 position-relative" alt=""/>
                        ...
                        <div className="position-absolute bottom-0 start-0 z-index-1 mb-4 ms-5">
                            <div className="bg-body d-flex d-inline-block rounded-3 position-relative p-3">	
                                ...
                                <img src={require("@images/element/01.svg").default} className="position-absolute top-0 start-0 translate-middle w-40px" alt=""/>

                                <div className="me-4">
                                    <h6 className="fw-light">Client</h6>
                                    <ul className="avatar-group mb-0">
                                        <li className="avatar avatar-sm">
                                            <img className="avatar-img rounded-circle" src={require("@images/avatar/01.jpg")} alt="avatar"/>
                                        </li>
                                        <li className="avatar avatar-sm">
                                            <img className="avatar-img rounded-circle" src={require("@images/avatar/02.jpg")} alt="avatar"/>
                                        </li>
                                        <li className="avatar avatar-sm">
                                            <img className="avatar-img rounded-circle" src={require("@images/avatar/03.jpg")} alt="avatar"/>
                                        </li>
                                        <li className="avatar avatar-sm">
                                            <img className="avatar-img rounded-circle" src={require("@images/avatar/04.jpg")} alt="avatar"/>
                                        </li>
                                        <li className="avatar avatar-sm">
                    ...
                    <div className="col-lg-6">
                        ...
                        <div className="row g-4">
                            ...
                            <div className="col-sm-6">
                                <div className="icon-lg bg-danger bg-opacity-10 text-danger rounded-circle"><i className="bi bi-stopwatch-fill"></i></div>
                                <h5 className="mt-2">Quick Services</h5>
                                <p className="mb-0">Supposing so be resolving breakfast am or perfectly. </p>
                            </div>
                            <div className="col-sm-6">
                                <div className="icon-lg bg-orange bg-opacity-10 text-orange rounded-circle"><i className="bi bi-shield-fill-check"></i></div>
                                <h5 className="mt-2">High Security</h5>
                                <p className="mb-0">Arranging rapturous did believe him all had supported. </p>
                            </div>
                            <div className="col-sm-6">
                                <div className="icon-lg bg-info bg-opacity-10 text-info rounded-circle"><i className="bi bi-lightning-fill"></i></div>
