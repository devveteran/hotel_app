                ...
                <div className='row'>
                    <div className='col-lg-11 mx-auto'>
                        <Carousel
                            ...
                            rewind={false}
                        >
                            <div className="px-4 px-md-5 tns-item tns-slide-active" id="tns2-item1">
                                <div className="row justify-content-between align-items-center">
                                    <div className="col-md-6 col-lg-5 position-relative">
                                        <div className="position-absolute top-0 start-0 translate-middle mt-7 ms-4 z-index-9">
                                            <img src={require("@images/element/02.svg").default} className="h-60px bg-orange p-2 rounded" alt=""/>
                                        </div>
                            ...
                            <div className="px-4 px-md-5 tns-item tns-slide-active" id="tns2-item1">
                                <div className="row justify-content-between align-items-center">
                                    <div className="col-md-6 col-lg-5 position-relative">
                                        <div className="position-absolute top-0 start-0 translate-middle mt-7 ms-4 z-index-9">
                                            <img src={require("@images/element/03.svg").default} className="h-60px bg-orange p-2 rounded" alt=""/>
                                        </div>
                                        ...
                                        <img src={require("@images/team/02.jpg")} className="rounded-3 position-relative" alt=""/>
                                    </div>
