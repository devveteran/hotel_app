...
const HeaderLeft = () => {
    ...
    return (
        <div className={'headerleft'}> 
            <Navbar expand="lg" style={{position:'initial'}}>
                {/* <Container> */}
            ...
            <Navbar expand="lg" style={{flexGrow:'1'}}>
            ...
            <Navbar id="home-nav-notification" expand="lg" style={{position:'initial'}} className='ms-md-3'>
            ...
            <Navbar id="home-nav-user" expand="lg" className='ms-3' style={{position:'initial'}}>
